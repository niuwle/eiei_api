...
async def construct_photo_finder_prompt(requested_photo: str, file_list: str) -> str:
   ...
   prompt = (
      ...
      "- User Description: \"Show me a photo of a red car.\"\n"
      "  - AI Response: cars_red_car_in_the_forest_racing.jpg\n"
      "- User Description: \"I want to see a modern house.\"\n"
      "  - AI Response: houses/modern house in the usa.jpeg\n"
      "- User Description: \"Find me a picture involving nature.\"\n"
      "  - AI Response: cars/blue car in the grass.jpg;houses/simpsons house.jpg\n"
      "\nImportant Notes:\n"
